    ...
    <div class="container">
        ...
        <div class="row tags">
            <div class="col-xs-12 text-center">
                ...
                <span class="separator"></span>
                <?= $tag_list = get_the_tag_list( '<div class="tag-list"><a href="'.home_url('blog').'">'.__('All', 'gogalapagos').'</a><span class="tag-separator">|</span>', '<span class="tag-separator">|</span>', '</div>' ); ?> 
            </div>
        </div>
    </div>
</div>
