    ...
    <div class="row">
        <div class="col-xs-12">
            <ul class="list-inline ship-navbar-items">
                ...
                <li><a class="regular-link" href="#lets-create-moments"><?php _e('Let\'s create moments' ,'gogalapagos'); ?></a></li>
                */ ?>
                <li><a href="<?= home_url('request-a-quote') ?>" class="plan-your-trip-single-btn about"><?php _e('Request a Quote','gogalapagos'); ?></a></li>
            </ul>
        </div>
    </div>
</div>