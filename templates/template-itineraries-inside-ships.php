                                            ...
                                            echo '<div class="col-sm-8">';
                                                echo '<div class="row">';
                                                    echo '<div class="col-sm-6">';
                                                        echo '<img src="' . get_post_meta($itinerariosSimples[$i]->ID, $prefix . 'itinerary_route_image', true ) . '" class="img-responsive">';
                                                    echo '</div>';
                                                    echo '<div class="col-sm-6">';
                                                        echo '<img src="' . get_post_meta($itinerariosSimples[$next]->ID, $prefix . 'itinerary_route_image', true ) . '" class="img-responsive">';
                                                    echo '</div>';
                                                echo '</div>';
                                            echo '</div>';
                                        ?>
