        ...
        <div class="row">
            <div style="display: flex;">
                ...
                <div style="width: 50%;">
                    <div class="row">
                        <div class="col-xs-12">
                            <img class="img-responsive" style="margin-bottom: 18px;" src="<?= get_template_directory_uri() ?>/images/alter-nav-default-experience.jpg" alt="<?= _e('The Go Galapagos Experience', 'gogalapagos') ?>">
                        </div>
                    </div>
                    <div class="row">
                        <?php foreach($barcos as $barco){ ?>
