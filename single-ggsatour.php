    ...
    <div class="container-fluid single-hero-content">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <h3><?php _e('From','gogalapagos'); ?>: $ <?= get_post_meta( get_the_ID(), $prefix . 'tour_price', true) ?> <small><?php _e('per person','gogalapagos'); ?></small></h3>
            ...
            <div class="col-sm-7 col-md-7 col-md-offset-1">
                ...
                <div id="main_content">
                    ...
                    <div class="featured-information">
                        <?php 
                            $highlights = get_post_meta(get_the_ID(), $prefix . 'sa_highlights', true);
                            $includes = get_post_meta(get_the_ID(), $prefix . 'sa_included', true);
                        ?>
                        <h3 class="sa-tour-featured-title"><?= _e('Tour Highlight', 'gogalapagos')?></h3>
                        <ul>
                        <?php 
                        ...
                        <h3 class="sa-tour-featured-title"><?= _e('Included', 'gogalapagos')?></h3>
                        <ul>
                        <?php 
...
<div class="sections section more-items-slider">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="text-center single-more-island-section-title"><?php _e('More South American Tours','gogalapagos'); ?></h2>
            </div>
        </div>
        <div class="row">
